interface IERC1155Receiver {
    function onERC1155Received(address operator, address sender, uint256 id, uint256 amount, bytes[CALLBACK_NUMBYTES] data) external payable returns (bytes32);
    function onERC1155BatchReceived(address operator, address sender, uint256[] ids, uint256[] amounts, bytes[CALLBACK_NUMBYTES] data) external payable returns (bytes4);
}
interface IERC1155MetadataURI {
    function uri(uint256 id) external view returns (string[MAX_URI_LENGTH]);
}
...
contract FromVyper {
    ...
    */
    constructor (string[128] name, string[16] symbol, string[MAX_URI_LENGTH] uri, string[MAX_URI_LENGTH] contractUri) external
    {
        name = name;
        symbol = symbol;
        owner = msg.sender;
    ...
    */
    function mint(address receiver, uint256 id, uint256 amount, bytes32 data) external
    {
        require(
            !paused,
            "The contract has been paused"
    ...
    @param data the data associated with this mint. Usually stays empty
    */
    function mintBatch(address receiver, uint256[] ids, uint256[] amounts, bytes32 data) external
    {
        require(
            !paused,
            "The contract has been paused"
    ...
    */
    function burnBatch(uint256[] ids, uint256[] amounts) external
    {
        require(
            !paused,
            "The contract has been paused"
    ...
    */
    function safeTransferFrom(address sender, address receiver, uint256 id, uint256 amount, bytes32 bytes) external
    {
        require(
            !paused,
            "The contract has been paused"
    ...
    */
    function safeBatchTransferFrom(address sender, address receiver, uint256[] ids, uint256[] amounts, bytes32 _bytes) external
    {
        require(
            !paused,
            "The contract has been paused"
    ...
    @param uri the new uri for the contract
    */
    function setURI(string[MAX_URI_LENGTH] uri) external
    {
        require(
            !paused,
            "The contract has been paused"
    ...
    */
    function toggleDynUri(bool status) external
    {
    ...
    */
    function uri(uint256 id) external view returns (string[MAX_URL_LENGTH])
    {
        if (dynamicUri) {
    ...
    */
    function setContractURI(string[MAX_URI_LENGTH] contractUri) external
    {
        require(
            !paused,
            "The contract has been paused"
