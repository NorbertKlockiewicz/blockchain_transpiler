interface Exchange {
    function token() public external view returns (ERC20);
...
contract FromVyper {
    ...
    // ##### VYPER DECORATORS #####
    // @external
    constructor (bytes32 _exchange_codehash) private external
    {
    ...
    // ##### VYPER DECORATORS #####
    // @external
    function register() public external
    {
    ...
    // ##### VYPER DECORATORS #####
    // @external
    function trade(ERC20 _token1, ERC20 _token2, uint256 _amt) public external
    {
