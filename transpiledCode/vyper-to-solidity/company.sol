...
contract FromVyper {
    ...
    // ##### VYPER DECORATORS #####
    // @external
    constructor (address _company, uint256 _total_shares, uint256 initial_price) external
    {
    ...
    // ##### VYPER DECORATORS #####
    // @external
    function sellStock(uint256 sell_order) external
    {
    ...
    // ##### VYPER DECORATORS #####
    // @external
    function transferStock(address receiver, uint256 transfer_order) external
    {
