...
contract FromVyper {
    ...
    // ##### VYPER DECORATORS #####
    // @external
    constructor (address _beneficiary, uint256 _biddingTime, uint256 _revealTime) private external
    {
    ...
    // @external
    // @payable
    function bid(bytes32 _blindedBid) public external payable
    {
    ...
    // ##### VYPER DECORATORS #####
    // @internal
    function placeBid(address bidder, uint256 _value) public internal returns (bool)
    {
    ...
    // ##### VYPER DECORATORS #####
    // @external
    function reveal(int128 _numBids, uint256[128] _values, bool[128] _fakes, bytes32[128] _secrets) public external
    {
    ...
    // ##### VYPER DECORATORS #####
    // @external
    function auctionEnd() public external
    {
