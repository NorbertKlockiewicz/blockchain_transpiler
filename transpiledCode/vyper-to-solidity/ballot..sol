...
contract FromVyper {
    ...
    // @view
    // @internal
    function _delegated(address addr) private internal view returns (bool)
    {
    ...
    // @view
    // @external
    function delegated(address addr) public external view returns (bool)
    {
    ...
    // @view
    // @internal
    function _directlyVoted(address addr) private internal view returns (bool)
    {
    ...
    // @view
    // @external
    function directlyVoted(address addr) public external view returns (bool)
    {
    ...
    // ##### VYPER DECORATORS #####
    // @external
    constructor (bytes32[2] _proposalNames) private external
    {
    ...
    // ##### VYPER DECORATORS #####
    // @external
    function giveRightToVote(address voter) public external
    {
    ...
    // ##### VYPER DECORATORS #####
    // @internal
    function _forwardWeight(address delegate_with_weight_to_forward) private internal
    {
    ...
    // ##### VYPER DECORATORS #####
    // @external
    function forwardWeight(address delegate_with_weight_to_forward) public external
    {
    ...
    // ##### VYPER DECORATORS #####
    // @external
    function delegate(address to) public external
    {
    ...
    // ##### VYPER DECORATORS #####
    // @external
    function vote(int128 proposal) public external
    {
        // can't vote twice
        require(!voters[msg.sender].voted);
    ...
    // @view
    // @internal
    function _winningProposal() private internal view returns (int128)
    {
    ...
    // @view
    // @external
    function winningProposal() public external view returns (int128)
    {
    ...
    // @view
    // @external
    function winnerName() public external view returns (bytes32)
    {
