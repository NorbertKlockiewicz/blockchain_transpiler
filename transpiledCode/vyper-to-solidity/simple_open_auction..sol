...
contract FromVyper {
    ...
    // ##### VYPER DECORATORS #####
    // @external
    constructor (address _beneficiary, uint256 _auction_start, uint256 _bidding_time) private external
    {
    ...
    // @external
    // @payable
    function bid() public external payable
    {
    ...
    // ##### VYPER DECORATORS #####
    // @external
    function endAuction() public external
    {
