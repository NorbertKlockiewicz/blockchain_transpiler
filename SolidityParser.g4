...
literal: stringLiteral | numberLiteral | boolLiteral | hexStringLiteral | unicodeStringLiteral;
...
yulbool: YulTrue | YulFalse;
yulLiteral: YulDecimalNumber | YulStringLiteral | YulHexNumber | yulbool | YulHexStringLiteral;
