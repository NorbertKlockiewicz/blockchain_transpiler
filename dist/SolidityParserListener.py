# Generated from SolidityParser.g4 by ANTLR 4.12.0
from antlr4 import *
...
class SolidityParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by SolidityParser#contractFunctionDefinition.
    def enterContractFunctionDefinition(self, ctx:SolidityParser.ContractFunctionDefinitionContext):
        pass

    # Exit a parse tree produced by SolidityParser#contractFunctionDefinition.
    def exitContractFunctionDefinition(self, ctx:SolidityParser.ContractFunctionDefinitionContext):
        pass


    # Enter a parse tree produced by SolidityParser#freeFunctionDefinition.
    def enterFreeFunctionDefinition(self, ctx:SolidityParser.FreeFunctionDefinitionContext):
        pass

    # Exit a parse tree produced by SolidityParser#freeFunctionDefinition.
    def exitFreeFunctionDefinition(self, ctx:SolidityParser.FreeFunctionDefinitionContext):
        pass
    ...
    def enterBoolLiteral(self, ctx:SolidityParser.BoolLiteralContext):
        pass

    # Exit a parse tree produced by SolidityParser#boolLiteral.
    def exitBoolLiteral(self, ctx:SolidityParser.BoolLiteralContext):
        pass
    ...
    def enterYulbool(self, ctx:SolidityParser.YulboolContext):
        pass

    # Exit a parse tree produced by SolidityParser#yulbool.
    def exitYulbool(self, ctx:SolidityParser.YulboolContext):
        pass
